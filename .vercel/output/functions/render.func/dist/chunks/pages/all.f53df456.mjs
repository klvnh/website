...
<body>
    ...
    <div id="container" class="font-mono">
        ...
        <div id="wrap" class="flex justify-center items-center h-screen">
            ...
            <div id="intro" class="m-3 text-xl font-bold underline decoration-4 underline-offset-[8px] sm:text-xl md:text-2xl lg:text-3xl">
                Hello, Im Kelvin.
            </div>
        ...
        <div id="about-me" class="bg-black opacity-90 h-screen">
            <h1 class="pt-20 pl-20 pr-20 text-xl text-white underline decoration-4 underline-offset-[8px] sm:text-xl md:text-2xl lg:text-3xl">About me</h1>
        </div>
